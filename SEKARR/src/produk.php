            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h2 style="color: black;">Detail Product</h2>
                        <span style="color: black;">Terimakasih Telah Percaya Kepada Kami</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="left-images">
                    ...
                    <div class="right-content">
                        <h4>FLAT SHOES</h4>
                        <span>Sepatu flats biasanya memiliki sol yang datar dan ciri khas yaitu di bagian depan yang tertutup dan memiliki desain feminin yang beragam</span>
                        <div class="quote">
                            <i class="fa fa-quote-left"></i><p>Wanita yang menyukai sepatu flats biasanya wanita yang memiliki kepribadian simple dan feminin</p>
                        </div>
                        <br>
                        <h2>Order Here</h2>
                        <div class="total">
                        <div class="main-border-text">
...
<div class="quote">
    <i class="fa fa-quote-left"></i><p>Sepatu model ini selalu mencuri perhatian dunia mode</p>
</div>
<br>
<br>
<h2>Order Here</h2>
